 ...
 */
function popster_customize_preview_js() {
	wp_enqueue_script( 'popster_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
add_action( 'customize_preview_init', 'popster_customize_preview_js' );

/**
 * Binds JS handlers for the helper in the customizer admin.
 */
function popster_customize_admin_js() {
	wp_enqueue_script( 'popster_customizer_admin', get_template_directory_uri() . '/js/customizer-admin.js', array( ), '20141114', true );
	//wp_enqueue_style( 'popster_customizer_admin_style', get_template_directory_uri() . '/css/admin-customizer.css' );
}
add_action( 'customize_controls_enqueue_scripts', 'popster_customize_admin_js' );
